...
void mainGame_onEnter(struct Scene *self) {
...
void mainGame_update(struct Scene *self) {
...
void mainGame_render(struct Scene *self) {
...
void mainGame_onExit(struct Scene *self) {
}
...
void mainGameUI_update(struct Scene *self) {
}

void mainGameUI_render(struct Scene *self) {
...
void mainGameUI_onEnter(struct Scene *self) {
...
void mainGameUI_onExit(struct Scene *self) {
}
